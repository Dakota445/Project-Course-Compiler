        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT COUNT(*) FROM bshm WHERE StudentID = @StudentID AND PassW = @Password";
                    ...
                    if (count > 0)
                    {
                        ...
                        BSHMPcc BSHMcompiler = new BSHMPcc();
                        BSHMcompiler.Show();
                        this.Close();
                    }
                    else
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = "INSERT INTO bshm (StudentID, FullName, Department, YearLevel, PassW) " +
