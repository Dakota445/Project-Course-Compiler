...
{
    public partial class CRIM_Menu : Form
    {
        public CRIM_Menu()
        {
            InitializeComponent();
        ...
        {
            CRIM_area.Small_Forms.CRIM_Add add = new CRIM_area.Small_Forms.CRIM_Add();
            add.ShowDialog();
            refreshTable();
        }
        ...
        {
            Small_Forms.CRIM_Update update = new Small_Forms.CRIM_Update(Stored_ID);
            update.ShowDialog();
            refreshTable();
        }
        ...
        private void CRIM_Menu_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
