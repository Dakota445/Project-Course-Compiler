...
{
    public partial class CRIM_Register : Form
    {
        public CRIM_Register()
        {
            InitializeComponent();
        }
        string consstring = Program.GlobalConsstring;
        string Courseee = "CRIM";
        ...
        private void CRIM_Register_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
