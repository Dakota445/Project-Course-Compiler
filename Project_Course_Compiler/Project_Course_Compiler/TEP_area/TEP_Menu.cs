...
{
    public partial class TEP_Menu : Form
    {
        public TEP_Menu()
        {
            InitializeComponent();
        ...
        {
            Small_Forms.TEP_Update update = new Small_Forms.TEP_Update(Stored_ID);
            update.ShowDialog();
            refreshTable();
        }
        ...
        private void TEP_Menu_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void TEP_Menu_Load(object sender, EventArgs e)
        {
